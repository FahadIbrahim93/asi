...
execute_optimization_readiness = executor_module._execute_optimization_readiness
validate_optimization_readiness_execution = (
    executor_module._validate_optimization_readiness_execution
)
...
def test_executor_derives_and_validator_recomputes_real_measurements() -> None:
    ...
    assert artifact["identity"]["authorization"] == {
        "authorization_transition_approved": False,
        "execution_authorized": False,
    }
